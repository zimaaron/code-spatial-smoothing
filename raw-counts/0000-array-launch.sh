...
#SBATCH --job-name="runLR-1" # job name
...
Rscript --vanilla /home/aeoz001/a-s-omics/code-spatial-smoothing/mouse-embryo/array-run-job.R 2024-08-27 1 0
## launch from a-s-omics with
## sbatch ./code-spatial-smoothing/mouse-embryo/array-launch-time-01.sh
